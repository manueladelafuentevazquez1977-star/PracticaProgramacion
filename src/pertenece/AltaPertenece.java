...
public class AltaPertenece extends WindowAdapter implements ActionListener
{
    Frame ventana = new Frame("Alta Pertenece");
    
    Label lblIdSatelite = new Label("ID Satélite:");
    TextField txtIdSatelite = new TextField(10);
    ...
    public AltaPertenece()
    {
        ...
        ventana.add(lblIdSatelite);
        ventana.add(txtIdSatelite);
    ...
    public void actionPerformed(ActionEvent evento)
    {
        if (evento.getSource().equals(btnAceptar))
        {
            try
            {
                ...
                sentenciaSQL = "INSERT INTO pertenece (idSateliteFK, idPaisFK) "
                             + "VALUES (" + txtIdSatelite.getText() + ", " 
                             + txtIdPais.getText() + ")";
        ...
        {
            txtIdSatelite.setText("");
            txtIdPais.setText("");
            txtIdSatelite.requestFocus();
        }
    }
}
